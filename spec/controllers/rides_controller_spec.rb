...
RSpec.describe RidesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested ride as @ride" do
      ride = Ride.create! valid_attributes
      get :show, {:id => ride.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested ride as @ride" do
      ride = Ride.create! valid_attributes
      get :edit, {:id => ride.to_param}, valid_session
      expect(assigns(:ride)).to eq(ride)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Ride" do
        expect {
          post :create, {:ride => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved ride as @ride" do
        post :create, {:ride => invalid_attributes}, valid_session
        expect(assigns(:ride)).to be_a_new(Ride)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested ride" do
        ride = Ride.create! valid_attributes
        put :update, {:id => ride.to_param, :ride => new_attributes}, valid_session
        ride.reload
      ...
      it "assigns the requested ride as @ride" do
        ride = Ride.create! valid_attributes
        put :update, {:id => ride.to_param, :ride => valid_attributes}, valid_session
        expect(assigns(:ride)).to eq(ride)
      end
    ...
    context "with invalid params" do
      it "assigns the ride as @ride" do
        ride = Ride.create! valid_attributes
        put :update, {:id => ride.to_param, :ride => invalid_attributes}, valid_session
        expect(assigns(:ride)).to eq(ride)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested ride" do
      ride = Ride.create! valid_attributes
      expect {
        delete :destroy, {:id => ride.to_param}, valid_session
      }.to change(Ride, :count).by(-1)
    end
